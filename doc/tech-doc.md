...
- [ ] 使用 XcodeGen 建立 iOS 專案結構
- [ ] 實作設計系統（Colors, Typography, Spacing）基於 UI Guideline 純粹雙色系統
- [ ] 建立 iOS HomeView 與 EventViewModel (Mock 資料)
- [ ] 建立 iOS NotificationSettingsView
- [ ] 建立選擇頁面（DeitySelectionView、FestivalSelectionView）
- [ ] 撰寫單元測試（iOS ViewModels）
- [ ] 部署到 TestFlight 進行內測
