// Solar Terms Constants - 24節氣常數檔案
// 前後端共用，避免硬編碼重複
...
// ES6 模組支援（供 React Admin 使用）
if (typeof module === 'undefined') {
  window.SolarTermsConstants = {
    SOLAR_TERMS,
    getSolarTermChoices,
    getSolarTermsBySeason,
    getSolarTermByName,
